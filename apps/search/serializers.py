...
class SearchPropertySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_bedrooms', 'total_bathrooms', 'area_sqft',
            'furnishing', 'has_parking', 'has_internet',
            'has_water_supply', 'has_electricity_backup',
            'has_garden', 'has_balcony',
            'rent_price', 'security_deposit', 'advance_months',
            'status', 'available_rooms',
            'owner_name', 'owner_phone',
            'cover_photo', 'target_type',
        ]
...
class SearchRoomSerializer(serializers.ModelSerializer):
    ...
    property_landmark = serializers.CharField(source='property.landmark',      read_only=True)
    ...
    wifi           = serializers.BooleanField(source='facility.wifi',          read_only=True, default=False)
    ac             = serializers.BooleanField(source='facility.ac',            read_only=True, default=False)
    parking        = serializers.BooleanField(source='facility.parking',       read_only=True, default=False)
    laundry        = serializers.BooleanField(source='facility.laundry',       read_only=True, default=False)
    lift           = serializers.BooleanField(source='facility.lift',          read_only=True, default=False)
    cctv           = serializers.BooleanField(source='facility.cctv',          read_only=True, default=False)
    water_included = serializers.BooleanField(source='facility.water_included',read_only=True, default=False)
    ...
    class Meta:
        ...
        fields = [
            ...
            'rent_price', 'security_deposit', 'advance_months',
            'status', 'target_type',
            'property_title', 'property_city', 'property_type',
            'property_address', 'property_landmark',
            'owner_name', 'owner_phone',
            'wifi', 'ac', 'parking', 'laundry',
            'lift', 'cctv', 'water_included',
            'cover_photo',
        ]
