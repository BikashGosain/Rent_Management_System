...
urlpatterns = [
    # Tenant
    path('property/<int:pk>/',        api_views.BookPropertyAPI.as_view()),     # book whole property
    ...
    path('<int:pk>/owner-cancel/',     api_views.OwnerCancelBookingAPI.as_view()), # owner cancel
