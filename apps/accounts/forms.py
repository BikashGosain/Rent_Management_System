...
class RegisterForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        User.objects.filter(username=username, is_active=False, is_verified=False).delete()
        return username
    ...
    def clean_email(self):
        ...
        if User.objects.filter(email=email).exists():
            raise forms.ValidationError('This email is already registered with an active account.')
        return email
...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        model  = User
        fields = ['first_name', 'last_name', 'email', 'phone', 'photo', 'address', 'bio']
        widgets = {
