...
urlpatterns = [
    ...
    # Password
    path('forgot-password/',  api_views.ForgotPasswordAPI.as_view(),  name='api-forgot-password'),
    path('reset-password/',   api_views.ResetPasswordAPI.as_view(),   name='api-reset-password'),

    # Profile
    path('profile/',          api_views.ProfileAPI.as_view(),         name='api-profile'),
    path('change-password/',  api_views.ChangePasswordAPI.as_view(),  name='api-change-password'),
]