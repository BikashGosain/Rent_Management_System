    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('house', 'House'), ('apartment', 'Apartment'), ('room', 'Room'), ('studio', 'Studio'), ('shop', 'Shop/Commercial'), ('flat', 'Flat'), ('villa', 'Villa'), ('office', 'Office Space'), ('warehouse', 'Warehouse'), ('other', 'Other')], max_length=20)),
