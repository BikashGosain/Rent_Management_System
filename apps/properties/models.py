...
class Property(models.Model):
    ...
    landmark = models.CharField(max_length=200, blank=True, help_text='e.g. Near bus stop, Near school')
    ...
    area_sqft       = models.PositiveIntegerField(null=True, blank=True, help_text='Total area in sq ft')
    ...
    advance_months   = models.PositiveIntegerField(default=1, help_text='Advance payment in months')
...
class Room(models.Model):
    ...
    # Basic Info
    room_number = models.CharField(max_length=20, help_text='e.g. 101, A1, Ground Floor Room')
    room_type   = models.CharField(max_length=20, choices=ROOM_TYPES, default='single')
    description = models.TextField(blank=True)

    # Room Details
    bedrooms      = models.PositiveIntegerField(default=1)
    bathroom_type = models.CharField(max_length=20, choices=BATHROOM_TYPES, default='shared')
    kitchen_type  = models.CharField(max_length=20, choices=KITCHEN_TYPES, default='shared')
    ...
    class Meta:
        ...
        unique_together = ['property', 'room_number']  # no duplicate room numbers in same property
