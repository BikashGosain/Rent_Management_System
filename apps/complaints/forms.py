    ...
    class Meta:
        ...
        widgets = {
            "description": forms.Textarea(
                attrs={"rows": 4, "placeholder": "Describe the issue in detail..."}
            ),
            "title": forms.TextInput(
                attrs={"placeholder": "Brief title of the complaint"}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            "message": forms.Textarea(
                attrs={"rows": 3, "placeholder": "Write your response..."}
            ),
        }
...
class OwnerComplaintForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "description": forms.Textarea(
                attrs={"rows": 4, "placeholder": "Describe the issue with tenant..."}
            ),
