...
class Complaint(models.Model):
    ...
    agreement = models.ForeignKey(Agreement, on_delete=models.SET_NULL, null=True, blank=True, related_name='complaints')
...
class ComplaintResponse(models.Model):
    ...
    attachment  = models.ImageField(upload_to='complaint_responses/', null=True, blank=True)
    created_at  = models.DateTimeField(auto_now_add=True)
